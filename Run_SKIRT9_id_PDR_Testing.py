...
def run_skirt(snap,sub,cam,sim_tag,sim_path,tmp_path,skirt_path):
    ...
    filedata = re.sub('wavelengthBias="0.5"','wavelengthBias="1.0"',filedata)
    filedata = re.sub('sourceBias="0.5"','sourceBias="1.0"',filedata)
...
if __name__=='__main__':
    ...
    sim_tag = 'TNG50-1'
    sim_path = f'/lustre/work/connor.bottrell/Simulations/IllustrisTNG/{sim_tag}/output'
    tmp_path = f'/lustre/work/connor.bottrell/Simulations/IllustrisTNG/TNG50-1/postprocessing/SKIRT9/Tests/PDR/shalo_{snap:03}-{sub}_uncorrected_fpdr00_wlbias10_sbias10/'
    project_path = '/lustre/work/connor.bottrell/Simulations/IllustrisTNG'
    skirt_path = f'{project_path}/Scripts/SKIRT'
    phot_path = tmp_path
